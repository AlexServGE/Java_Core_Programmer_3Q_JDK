...
public class Map extends JPanel {
    ...
    private char HUMAN_DOT = 1;
    private char AI_DOT = 2;
    private char HUMAN_DOT_2 = 3;
    private int numberTurn = 0;
    private char EMPTY_DOT = 0;
     ...
     * @param e
     */
    private void update(MouseEvent e) { //благодаря постоянному действию этого метода игра продолжается
        ...
        switch (curMode) {
            ...
            case 1:
                if (numberTurn++ % 2 == 0) {
                    ...
                    if (!isValidCell(cellX, cellY) || !isEmptyCell(cellX, cellY)) return;
                    field[cellY][cellX] = HUMAN_DOT_2;
                    if (checkEndGame(HUMAN_DOT_2, STATE_WIN_HUMAN_2)) {
                        numberTurn = 0;
                        return;
                    }
                }
    ...
    private void render(Graphics g) { //Бесконечный цикл из очереди paintComponent
        ...
        this.cellWidth = panelWidth / fieldSizeY;
        this.cellHeight = panelHeight / fieldSizeX;
